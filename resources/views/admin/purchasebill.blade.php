            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form enctype="multipart/form-data" class="form-sample" action="{{ route('admin.addpurchasebill')}}" method="post">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <div class="form-check">
                            <label class="form-check-label">
                              <input id="inside" type="radio" class="form-check-input" name="statePurchase" value="inside">
                              Inside Kerala
                            </label>
                          </div>
                        </div>
                        <div class="col-sm-5">
                          <div class="form-check">
                            <label class="form-check-label">
                              <input id="outside" type="radio" class="form-check-input" name="statePurchase" value="outside">
                              Outside Kerala
                            </label>
                          </div>
                        </div>
                    ...
                    <table id="wo_amt_table2" class="form" ;>
                      ...
                      <tr>
                        ...
                        <td><input required value="0" readonly class="form-control " type="text" class="small" name="cgst[]" style="width: 100%" required style="border:0px"></td>

                        <td><input required value="0" readonly class="form-control " type="text" class="small" name="sgst[]" style="width: 100%" required style="border:0px"></td>

                        <td><input required value="0" readonly class="form-control " type="text" class="small" name="igst[]" style="width: 100%" required style="border:0px"></td>
                      </tr>
